...
DEVICE="${EXPORT_DEVICE}" NUM_WORKER="${NUM_WORKER}" NUM_SAMPLES="${EXPORT_NUM_SAMPLES}" \
    bash "scripts/Analysis/export_electricity_probabilistic_decoupling_artifacts.sh"

MANIFEST_PATH="${MANIFEST_PATH:-./results/analysis/Electricity/probabilistic_decoupling/electricity_probabilistic_decoupling_manifest.json}" \
